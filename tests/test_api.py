"""Tests for BSBLAN custom component api."""
import asyncio

import aiohttp
from custom_components.bsblan_custom_component.api import (
    BSBLANApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = BSBLANApiClient("test", "test", async_get_clientsession(hass))
